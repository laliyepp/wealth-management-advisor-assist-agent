...
class AsyncFinancialDataTool:
    ...
    def __init__(
        ...
        """
        self.api_key = api_key or os.getenv("TWELVE_DATA_API_TOKEN")
        ...
        if not self.api_key:
            raise ValueError("API key is required. Set TWELVE_DATA_API_TOKEN environment variable or pass api_key parameter.")
